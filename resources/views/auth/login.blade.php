...
@section('content')
    ...
    <div class="header py-5 py-lg-5 pt-lg-4" style="background-color: #F0F1F5">
        <div class="container">
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        <h1 class="">Welcome!</h1>
                        <p class="text-lead ">Enter your email and password to login your account.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt--9 pb-5">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="card border border-soft" style="background-color: #B5ABA2">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input id="email" type="email" value="" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email"  placeholder="Email Address" autofocus>
