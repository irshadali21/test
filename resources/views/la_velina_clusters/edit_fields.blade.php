...
<div class="row" style="margin-top: -10px">
    ...
    <div class="col-lg-3">
        <div class="form-group">
            {{ Form::label('advisor_name', __('lang.ADVISOR'), ['class' => 'form-control-label']) }}
            <select name="advisor_name" id="advisor_name" class='form-control select2'>
                <option value="" selected>{{ __('lang.ADVISOR') }}</option>
...
<div class="row" style="margin-top: -20px">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            {{ Form::label('category', __('lang.Category'), ['class' => 'form-control-label']) }}
