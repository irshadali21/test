@extends('layouts.app')
@push('pg_btn')
    <a href="{{route('files.index')}}" class="btn btn-sm btn-neutral">{{ __('lang.All Files') }}</a>
@endpush
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    <h6 class="heading-small text-muted mb-4">{{ __('lang.File information') }}</h6>
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('fee', $file->fee, ['class' => 'form-control', 'placeholder' => 'Fee' , 'step' => 'any']) }}
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
