    ...
    <body >
        ...
        <div style="page-break-after: always;">
            ...
            <p>
                ...
                l’esecuzione dello stesso sarà affidato al Dott./Rag. {{ $auditor }} con studio in {{ $auditor_address }}, iscritto all'Ordine dei Dottori Commercialisti e degli Esperti Contabili {{ $auditor_city }}, sez.A / sez.B con il n. {{ $accountant_reg_no }}, e al n. {{ $auditor_reg_no }} del Registro dei Revisori, indirizzo e.mail/pec: <a href="mailto:{{ $auditor_pec_email }}">{{ $auditor_pec_email }}</a>
