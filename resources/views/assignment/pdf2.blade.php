...
<div style="page-break-after: always;">
    ...
    <body>
        ...
        <p>
            ...
            con il n. {{ $accountant_reg_no }}, e al n. {{ $auditor_reg_no }} del Registro dei Revisori, indirizzo
            e.mail/pec: {{ $auditor_pec_email }} che opera in proprio/quale associato dello studio
            {{ $auditor_office_no }} successivamente denominato
            "Professionista",

        </p>
        <p>
            il seguente incarico professionale, disciplinato dai seguenti articoli ed accettato dal Professionista
            mediante
            sottoscrizione della presente lettera d'incarico.
        </p>
        <p><strong>1) Oggetto dell'incarico </strong></p>
        <p>
            Certificazione relativa al credito d’imposta per {{ $benefits_name }} annualità {{ $benefits_year }},
            dell’azienda {{ $company_name }} , {{ $company_address }}, p.iva {{ $vat_number }}
        </p>
        <p>
            Nell'espletamento dell'incarico il Professionista può avvalersi, sotto la propria direzione e
            responsabilità, di
        ...
        <p>
            ...
            revisione
            SA Italia 250B e SA Italia 720B e al principio ISQC Italia 1 elaborati ai sensi dell’art. 11, comma 3, del
            D.Lgs.
            39/2010 e adottati con determina del Ragioniere Generale dello Stato in data 23 dicembre 2014, ovvero ad
            eventuali ulteriori principi di revisione che saranno adottati in sostituzione di quelli attualmente
            applicabili o
            di quelli che dovessero integrare gli stessi in materia di certificazione dle bilancio ovvero di
            certificazione
        ...
        <div class="pr">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span class="square">
                <span style="margin-left: 5px; margin-top:2px; ">X</span> 
            </span>
            <span class="text">
    ...
    <footer>
        <small>
            ...
            <p style="font-size: 11px;"> <strong>
                    REV-{{ $benefits_name }}-{{ $benefits_year }}-{{ $code_date }}-{{ $vat_number }}</strong>
                <span style="float:right"><strong>Pag. 1 di 4</strong></span> </p>
...
<div style="page-break-after: always;">
    ...
    <body>
        ...
        <p>
            I collaboratori sia autonomi sia subordinati che il professionista dovesse assumere per il miglior
            espletamento
        ...
        <p>
            Il Professionista incaricato non ha alcuna esclusività territoriale e la Società è libera di conferire
            incarico ad
        ...
        <p>
            b) Il Professionista, ai sensi dell'art. 2235 del c.c., trattiene la documentazione fornita dal Cliente per
            il
        ...
        <p>
            ...
            venuto a conoscenza in relazione all'espletamento dell'incarico; né degli stessi può fare uso, sia nel
            proprio
        ...
        <p>
            d) Ai sensi dell’art. 2399 c.c. e delle regole deontologiche che disciplinano la professione contabile,
            nonché
            delle disposizioni sull’indipendenza del revisore contenute nel D.Lgs. 39/2010, dichiaro sin d’ora la mia
            indipendenza nei confronti della società e l’insussistenza di cause di incompatibilità per l’assunzione di
            questo
            mandato.
        </p>
        ...
        <p>
            ...
            adempiuto agli obblighi di adeguata verifica della clientela previsti dagli articoli 16 e seguenti,
            attenendosi
            alla indicazioni contenute nelle linee guida emanate dal Consiglio Nazionale dei Dottori Commercialisti e
            degli
    ...
    <footer>
        <small>
            ...
            <p style="font-size: 11px;"> <strong>
                    REV-{{ $benefits_name }}-{{ $benefits_year }}-{{ $code_date }}-{{ $vat_number }}</strong>
                <span style="float:right"><strong>Pag. 2 di 4</strong></span> </p>
...
<div style="page-break-after: always;">
    ...
    <body>
        ...
        <p>
            Il Professionista può recedere dal contratto per giusta causa. Il diritto di recedere dal contratto deve
            essere
            esercitato dal Professionista in modo da non recare pregiudizio né alla Società né al Cliente finale,
            mediante
        ...
        <p>
            ...
            professionali,
            con apposita polizza n. {{ $insurance_no }} contratta con la Compagnia di Assicurazioni
            {{ $insurance_company }}
        </p>
        ...
        <p>
            ...
            comprese quelle relative alla sua validità, interpretazione, esecuzione, risoluzione e revoca sarà
            competente
        ...
        <p>
            Il Professionista incaricato si impegna - per se stesso e per i suoi eventuali colalboratori - nei confronti
            della
    ...
    <footer>
        <small>
            ...
            <p style="font-size: 11px;"> <strong>
                    REV-{{ $benefits_name }}-{{ $benefits_year }}-{{ $code_date }}-{{ $vat_number }}</strong>
                <span style="float:right"><strong>Pag. 3 di 4</strong></span> </p>
            <div style="font-size: 9px;">
                SOLIDA S.R.L. <br>
                Via Stella 1/G - 84091 Battipaglia (Sa) IT <br>
                p.iva 05829650653 <br>
...
<div>
    ...
    <body>
                    ...
                    <tr>
                        <td class="col-6 p-0">
                            ...
                            <center><img src="{{ $signature }}"
                                    style="width: 100%; max-width: 170px; max-height: 60;"></center>
                        </td>
                        <td align="right" class="col-6   p-0">
                            <span style="float: right">
                                <strong>
                                    <p style="text-align: left">Il Professionista</p>

                                    <p style="text-align: left">dott.</p>
                                    <p style="text-align: left">{{ $auditor }}</p>
                                    <img style="text-align: left" src="{{ $auditor_signature }}"
        ...
        <p>
            Il presente conferimento incarico viene redatto in duplice copia, consegnato alle parti, le quali dichiarano
            di
            averlo letto in ogni suo punto, di condividerne il contenuto e di accettarlo per intero escludendo,
            pertanto,
    ...
    <footer>
        <small>
            ...
            <p style="font-size: 11px;"> <strong>
                    REV-{{ $benefits_name }}-{{ $benefits_year }}-{{ $code_date }}-{{ $vat_number }}</strong>
                <span style="float:right"><strong>Pag. 4 di 4</strong></span> </p>
            <div style="font-size: 9px;">
                SOLIDA S.R.L. <br>
                Via Stella 1/G - 84091 Battipaglia (Sa) IT <br>
                p.iva 05829650653 <br>
