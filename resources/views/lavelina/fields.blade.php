...
<div id="body_div" class="row">
    <div id="firms_div" class="form-group col-sm-12" style="display: none">
        <!-- firms Field -->
        {!! Form::label('firms', 'Box 1:') !!}
        {!! Form::textarea('firms', null, ['class' => 'form-control']) !!}
    </div>
    <div id="benefits_div" class="form-group col-sm-12" style="display: none">
        <!-- benefits Field -->
        {!! Form::label('benefits', 'Box 2:') !!}
        {!! Form::textarea('benefits', null, ['class' => 'form-control ']) !!}
    </div>
    <div id="benefits_in_number_div" class="form-group col-sm-12" style="display: none">
        {!! Form::label('benefits_in_number', 'Box 3:') !!}
        {!! Form::textarea('benefits_in_number', null, ['class' => 'form-control ']) !!}
    </div>
    <div id="tax_breack_div" class="form-group col-sm-12" style="display: none">
        <!-- tax_breack Field -->
...
<div class="row" style="display: none" id="body3_div">
    <div class="col-sm-12">
        <h3>Page 3</h3>
    </div>
    <div class="col-sm-6 form-group">
        ...
        {{-- <span style="color:red">(less then 1500)</span> --}}
        <textarea name="body[]" id="body5" class="form-control" rows="23"></textarea>
    </div>
    <div class="col-sm-6 form-group">
        {!! Form::label('body', 'Testo articolo 3: ') !!}
        <textarea name="body[]" id="body6" class="form-control" rows="23"></textarea>
    </div>
...
<div class="row" style="display: none" id="body4_div">
    ...
    <div class="col-sm-6 form-group">
        ...
        <textarea name="body[]" id="body7" class="form-control" rows="23"></textarea>

    </div>
    <div class="col-sm-6 form-group">
        {!! Form::label('body', 'Testo articolo 4: ') !!}
        <textarea name="body[]" id="body8" class="form-control" rows="23"></textarea>
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-2">
