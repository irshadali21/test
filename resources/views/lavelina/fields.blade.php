<div class="row">
    ...
    <div class="form-group col-sm-2">
        <label for="chipuo_checkbox">Chi Può</label>
        <input type="checkbox" name="chipuo_checkbox" id="chipuo_checkbox">
    </div>
    <div class="form-group col-sm-2">
        <label for="percosa_checkbox">Per Cosa</label>
...
<div class="row">
    ...
    <div class="form-group col-sm-4">
        <label for="quanto_checkbox">Quanto</label>
        <input type="checkbox" class="body2div" name="quanto_checkbox" id="quanto_checkbox">
    </div>
    <div class="form-group col-sm-4">
        <label for="quali_checkbox">Quali agevolazioni:</label>
...
<div id="body2_row" class="row" style="display: none">
    <div class="form-group col-sm-12" style="display: none" id="body2_div">
        {!! Form::label('body', 'Testo articolo: ') !!}<span style="color:red">(less then 1500)</span>
        <textarea name="body[]" id="body1" class="form-control" rows="23"></textarea>
    </div>
